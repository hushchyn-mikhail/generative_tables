...
try:
    from eval.visualize_density import plot_density as _plot_density
except Exception:
    _plot_density = None
...
class TabMetrics(object):
    ...
    def evaluate_density(self, syn_data):
        if QualityReport is None or DiagnosticReport is None:
            print("Density evaluation is skipped because sdmetrics is not installed.")
            return {}, {}
    ...
    def evaluate_mle(self, syn_data):
        ...
        if get_evaluator is None:
            print("MLE evaluation is skipped because optional dependencies are not installed.")
            return {}, {}
    ...
    def evaluate_c2st(self, syn_data):
        if LogisticDetection is None:
            print("C2ST evaluation is skipped because sdmetrics is not installed.")
            return {}, {}
    ...
    def evaluate_dcr(self, syn_data):
        ...
        dcrs_real = []
        dcrs_test = []
        batch_size = 10000 // cat_real_data_oh.shape[1]
    ...
    def plot_density(self, syn_data):
        if _plot_density is None:
            print("Plot density is skipped because visualization dependencies are not installed.")
            return None
        ...
        img = _plot_density(syn_data_cp, real_data, info)
        return img
