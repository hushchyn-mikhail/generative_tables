...
from utils import TabularDataset, TabularEncoder
...
def main(dataset: str):
    ...
    def load_inputs():
        ...
        valid_dataset = TabularDataset(valid_array, encoder)
    ...
    @torch.no_grad()
    def validation_epoch(model: LinearImputer, loader: DataLoader, tqdm_desc: str):
        device = next(model.parameters()).device
        valid_losses = []
    ...
    def train_model(
        ...
        mlflow.set_experiment(f"{DATASET_NAME}-regression")
