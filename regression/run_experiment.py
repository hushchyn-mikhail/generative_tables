...
def main(dataset: str):
    ...
    def evaluate_loco(
        loader: DataLoader, model: RegressionImputer, device: torch.device
    ):
    ...
    loco_df.to_csv(f"{DATASET_NAME}/regression_{DATASET_NAME}_loco.csv", index=False)
    ...
    mcar_df.to_csv(f"{DATASET_NAME}/regression_{DATASET_NAME}_mcar.csv", index=False)
